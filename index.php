...
<head>
    ...
    <meta name="keywords" content="Bhavik Santhaliya, portfolio, Bhavik, full stack dev, personal portfolio lifecodes, portfolio design, portfolio website, personal portfolio" />
    <meta name="description" content="Welcome to Bhavik's Portfolio. Full-Stack Web Developer and Android App Developer" />
    <!-- Custom CSS -->
...
<section class="home" id="home">
    ...
    <div class="content">
    <h2>Hi There,<br/> I'm Bhavik <span>Santhaliya</span></h2>
    ...
    <div class="content">
        ...
        <div class="box-container">
            <div class="box">
              ...
              <p><span> phone : </span> +91 9054705039</p>
            </div>
            <div class="box">
              <p><span> email : </span> bsanthaliya100@rku.ac.in</p>
              <p><span> place : </span> Rajkot , gujrat</p>
            </div>
        </div>
        
        <div class="resumebtn">
            <a href="https://drive.google.com/file/d/139QqZf3zcY1fH9gPgeQ9uPkPmA112bLn/view?usp=sharing" target="_blank" class="btn"><span>Resume</span>
...
<section class="skills" id="skills">
    ...
    <div class="container">
          <div class="row" id="skillsContainer">
            ...
            <div class="bar">
              <div class="info">
                <img src="https://img.icons8.com/ios-filled/48/1169ae/jquery.png"/>
                <span>jquery</span>
              </div>
              </div>
            <div class="bar">
...
<section class="education" id="education">
  ...
  <h1 class="heading"><i class="fas fa-graduation-cap"></i> My <span>Education</span></h1>
    ...
    <div class="box">
        ...
        <p>Rk university school of Engineering | RKU(SOE)</p>
        <h4>2022-2026 | continue</h4>
        </div>
    </div>
    ...
    <div class="box">
      ...
      <div class="content">
      <h3>HSC Science | A Gruap</h3>
      <p>Shri Goverment school Gadhda(swa) | GSEB</p>
  ...
  <div class="timeline">
    ...
    <div class="container right">
      <div class="content">
        ...
        <div class="desc">
            <h3>Wordpress Developer | STUDY</h3>
...
<section class="footer">
  ...
  <div class="box-container">
      ...
      <div class="box">
          <h3>contact info</h3>
          <p> <i class="fas fa-phone"></i>+91 9054705039</p>
          <p> <i class="fas fa-envelope"></i>bsanthaliya100@rku.ac.in</p>
          <p> <i class="fas fa-map-marked-alt"></i>Rajkot , Gujrat</p>
          <div class="share">
              ...
              <a href="mailto:bsanthaliya100@rku.ac.in" class="fas fa-envelope" aria-label="Mail" target="_blank"></a>
